...
global $wpdb;
 ...
 $example_data = $wpdb->get_results( "SELECT  firstname,lastname,email,password,city,country,state  FROM  $table_name where 
   test_customer_id = '".$post_id."'");
 
       foreach ($example_data as $pagedata)
         {
...
?>
  ...
  <!--       <label for="image">Image</label>
    ...
    <a id="anchotag"href="http://localhost/wordpress/?page_id=203" target="_blank">Assigned Product</a>
<!-- <div class="clickbtn">
...
var  scrimage = '<img src="' + attachment.url + '">'
...
if (isset($_POST['update']))
 {
  ...
  //   $inserted = "UPDATE wp_test_customer SET firstname='".$firstname."',lastname='".$lastname."',email='".$email."',password='".$password."',city='".$city."',country='".$country."',state='".$state."'  WHERE test_customer_id='".$post_id."' " ;
